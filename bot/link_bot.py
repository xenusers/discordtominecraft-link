...
DB_HOST = os.getenv("MYSQL_HOST", "sql3.freesqldatabase.com")
DB_PORT = int(os.getenv("MYSQL_PORT", "3306"))
DB_NAME = os.getenv("MYSQL_DATABASE", "sql3818940")
DB_USER = os.getenv("MYSQL_USERNAME", "sql3818940")
DB_PASSWORD = os.getenv("MYSQL_PASSWORD", "")
DB_SSL = os.getenv("MYSQL_SSL", "true").lower() == "true"
BOT_TOKEN = os.getenv("DISCORD_BOT_TOKEN", "")


def get_connection() -> pymysql.Connection:
    ssl_config = {"ssl": {}} if DB_SSL else {}
...
if __name__ == "__main__":
    if not DB_PASSWORD:
        raise RuntimeError("Set MYSQL_PASSWORD before running the bot.")
    if not BOT_TOKEN:
